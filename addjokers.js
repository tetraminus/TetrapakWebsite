...
for (let category in data) {
  ...
  //     </div>
    ...
    let jokers_cards = document.createElement("div");
    jokers_cards.classList.add(category);
    jokers_cards.classList.add("cards");
    jokers_div.appendChild(jokers_cards);

  add_cards_to_div(jokers, jokers_cards);
}